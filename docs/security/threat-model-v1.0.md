...
| T-23 | پنهان‌شدن Opportunity Cost، پیشنهاد Action خارج از ظرفیت کاربر یا معتبر ماندن Decision stale | P0 | Feasibility قطعی برای Time/Energy/Visibility/Emotional Bandwidth، Utility و Opportunity Cost قابل مشاهده، Assumption/Uncertainty، Decision Window ۲۴ساعته، Human Approval و `externalActionPermitted=false` | پیش از Context پایدار، owner-controlled و چندجلسه‌ای، repository نسخه‌دار، approval invalidation، RLS و آزمون stale-context race الزامی است |
